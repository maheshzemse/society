                    ...
                    @endisset
                        @csrf
                         <div class="form-group row">
                            <label for="society_id" class="col-md-4 col-form-label  text-md-right">{{ __('Society Id') }}</label>


                        
                            <div class="col-md-6">
                                <input id="society_id" type="text" class="form-control @error('society_id') is-invalid @enderror" name="society_id" value="" required autocomplete="society_id" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contact_no" type="text" class="form-control @error('contact_no') is-invalid @enderror" name="contact_no" value="{{ old('mobile') }}" required autocomplete="mobile" autofocus >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
